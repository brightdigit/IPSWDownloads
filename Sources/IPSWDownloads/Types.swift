...
public enum Components {
  ...
  public enum Schemas {
    ...
    public struct FirmwareKey: Codable, Hashable, Sendable {
      ...
      public var keys: [Components.Schemas.Key]?
    ...
    public struct iTunes: Codable, Hashable, Sendable {
      ...
      public var datefound: Foundation.Date
    ...
    @frozen public enum Output: Sendable, Hashable {
      public struct Ok: Sendable, Hashable {
        ...
        @frozen public enum Body: Sendable, Hashable {
          ...
          /// - Throws: An error if `self` is not `.json`.
          /// - SeeAlso: `.json`.
          public var json: [Components.Schemas.iTunes] {
            get throws {
              switch self {
              case let .json(body):
                return body
    ...
    @frozen public enum Output: Sendable, Hashable {
      public struct Ok: Sendable, Hashable {
        ...
        @frozen public enum Body: Sendable, Hashable {
          ...
          /// - Throws: An error if `self` is not `.json`.
          /// - SeeAlso: `.json`.
          public var json: [Components.Schemas.FirmwareKey] {
            get throws {
              switch self {
              case let .json(body):
                return body
