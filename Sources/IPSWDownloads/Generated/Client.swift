...
internal struct Client: APIProtocol {
    ...
    internal func firmwaresForDevice(_ input: Operations.firmwaresForDevice.Input) async throws -> Operations.firmwaresForDevice.Output {
    ...
    internal func devices(_ input: Operations.devices.Input) async throws -> Operations.devices.Output {
        try await client.send(
            input: input,
    ...
    internal func ipswDownload(_ input: Operations.ipswDownload.Input) async throws -> Operations.ipswDownload.Output {
        try await client.send(
            input: input,
    ...
    internal func ipswByIdentifierAndBuild(_ input: Operations.ipswByIdentifierAndBuild.Input) async throws -> Operations.ipswByIdentifierAndBuild.Output {
        try await client.send(
            input: input,
    ...
    internal func ipswListForVersion(_ input: Operations.ipswListForVersion.Input) async throws -> Operations.ipswListForVersion.Output {
        try await client.send(
            input: input,
    ...
    internal func itunesDownloadForPlatformAndVersion(_ input: Operations.itunesDownloadForPlatformAndVersion.Input) async throws -> Operations.itunesDownloadForPlatformAndVersion.Output {
        try await client.send(
            input: input,
    ...
    internal func itunesForPlatform(_ input: Operations.itunesForPlatform.Input) async throws -> Operations.itunesForPlatform.Output {
        try await client.send(
            input: input,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            [Components.Schemas.iTunes].self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    internal func firmwareKeysForIdentifier(_ input: Operations.firmwareKeysForIdentifier.Input) async throws -> Operations.firmwareKeysForIdentifier.Output {
        try await client.send(
            input: input,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            [Components.Schemas.FirmwareKey].self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    internal func firmwareKeysForIdentifierAndBuild(_ input: Operations.firmwareKeysForIdentifierAndBuild.Input) async throws -> Operations.firmwareKeysForIdentifierAndBuild.Output {
        try await client.send(
            input: input,
    ...
    internal func identifierForModel(_ input: Operations.identifierForModel.Input) async throws -> Operations.identifierForModel.Output {
        try await client.send(
            input: input,
    ...
    internal func otaDocumentationForDeviceAndVersion(_ input: Operations.otaDocumentationForDeviceAndVersion.Input) async throws -> Operations.otaDocumentationForDeviceAndVersion.Output {
        try await client.send(
            input: input,
    ...
    internal func otaDownloadForIdentifierAndBuild(_ input: Operations.otaDownloadForIdentifierAndBuild.Input) async throws -> Operations.otaDownloadForIdentifierAndBuild.Output {
        try await client.send(
            input: input,
    ...
    internal func otaInformationForIdentifierAndBuild(_ input: Operations.otaInformationForIdentifierAndBuild.Input) async throws -> Operations.otaInformationForIdentifierAndBuild.Output {
        try await client.send(
            input: input,
    ...
    internal func otasForVersion(_ input: Operations.otasForVersion.Input) async throws -> Operations.otasForVersion.Output {
        try await client.send(
            input: input,
    ...
    internal func releases(_ input: Operations.releases.Input) async throws -> Operations.releases.Output {
        try await client.send(
            input: input,
